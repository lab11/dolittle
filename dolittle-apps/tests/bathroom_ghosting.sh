...
# External
python socket_source.py -name "JSON Input Client" -out ghosting/in -params '{"host": "10.0.0.227", "port": 7774}' &
...
# External
python socket_sink.py -name "JSON Output Client" -in ghosting/out -params '{"dest": "10.0.0.239", "port": 8080}' &
