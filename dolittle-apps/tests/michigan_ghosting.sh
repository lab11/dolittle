...
# External
#python socket_source.py -name "Input server" -out ghosting/in -params '{"host": "10.0.0.239", "port": 8000}' & # NOT DONE
...
#python hue_bulb_source.py -name 'Kitchen' -out livingroom/lights/status -params '{"bridge_addr": "10.0.0.225","bulb_name": "Kitchen"}' &
...
# External
#python socket_sink.py -name "Output client" -in ghosting/in -params '{"dest": "70.110.28.225", "port": 8080}' & # NOT DONE
...
#python hue_bulb_sink.py -name 'Kitchen' -in livingroom/lights/cmds -params '{"bridge_addr": "10.0.0.225","bulb_name": "Kitchen"}' &
